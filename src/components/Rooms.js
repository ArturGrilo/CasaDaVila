      ...
      <div className="cdv-main-container">
        ...
        <div className="rooms-grid">
          <div data-aos="fade-left" className="cdv-card" onClick={() => openPopup(1)}>
            <img loading="lazy" src="/images/Comodidades/CasaDaVilaI.webp" alt="Imagem Casa da Vila - Alojamento Local , Alpedrinha , Beira Baixa , Sintra da Beira"/>
          ...
          <div className="cdv-card" data-aos="fade-right" onClick={() => openPopup(2)}>
            <img loading="lazy" src="/images/Comodidades/CasaDaVilaII.webp" alt="Casa Da Vila - Piso Superior - Casa da Vila - Alojamento Local , Alpedrinha , Beira Baixa , Sintra da Beira"/>
            <div className="cdv-card-details">
