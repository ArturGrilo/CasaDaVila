      ...
      <div className="cdv-main-container">
        ...
        <div className="rooms-grid">
          <div data-aos="fade-left" className="cdv-card" onClick={() => openPopup(1)}>
            <img loading="lazy" src="/images/CasaDaVilaI/CasaDaVilaI_2.jpeg" alt="Imagem Casa da Vila - Alojamento Local , Alpedrinha , Beira Baixa , Sintra da Beira"/>
          ...
          <div className="cdv-card" data-aos="fade-right" onClick={() => openPopup(2)}>
            <img loading="lazy" src="/images/CasaDaVilaII/CasaDaVilaII_11.jpeg" alt="Casa Da Vila - Piso Superior - Casa da Vila - Alojamento Local , Alpedrinha , Beira Baixa , Sintra da Beira"/>
            <div className="cdv-card-details">
